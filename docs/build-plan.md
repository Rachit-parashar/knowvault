...
| Decision | Choice | Rationale (what you say in the interview) |
|---|---|---|
...
Given your GitLab CI/Trufflehog background, the security workflow will be fast to build — and "I run secret scanning and image scanning professionally and in my personal projects" is a nice consistency story.
...
5. "How would this scale 10x?" → index-per-tenant sharding, AKS migration path, provisioned throughput, regional replicas — all pre-written in your README.
